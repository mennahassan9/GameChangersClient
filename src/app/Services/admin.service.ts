...
export class AdminService {
  ...
  inviteCleader(user){
    ...
    return this.http.post(environment.apiUrl +"/admin/inviteCLeader",body, { headers: reqHeaders })
              .toPromise();
  }
  inviteRleader(user){
    const reqHeaders: Headers = new Headers();
    ...
    let body= JSON.stringify(user);
    return this.http.post(environment.apiUrl +"/admin/inviteRleader",body, { headers: reqHeaders })
              .toPromise();
  }
  ...
  inviteGleader(user) {
    ...
    reqHeaders.append('Authorization', 'Bearer ' + currentToken);
    let body= JSON.stringify(user);
    return this.http.post(environment.apiUrl + "/admin/inviteGleader",body, { headers: reqHeaders })
              .toPromise();
  }
  sendEmails(mailList, email): Observable<any> {
    ...
    reqHeaders.append('Authorization', 'Bearer ' + currentToken);
    reqHeaders.append('Content-Type', 'application/json');
    return this.http.post(environment.apiUrl + `/admin/email/global`, {emails: mailList, subject: email.subject, emailBody: email.body}, { headers: reqHeaders });
  }
}
